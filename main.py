...
#INITIALIZE CONFIG
confTreshold = 0.5	#Object detection confidence
nmsTreshold = 0.4	#Non-maximum suppression threshold (for drawing rectangles)
inpWidth = 416		#Width of network's input image
inpHeight = 416		#Height of network's input image

#Network files
classesFile = "coco.names"
networkWeights = "yolov3.weights"
networkConfig = "yolov3.cfg"

#Load yolo
def load_yolo():
	#Reading network, setting target and backend
	net = cv2.dnn.readNet(networkWeights, networkConfig)
